/**
 * Driver program for Assignments 1
 * Bitcoin and Cryptocurrency Technologies courses on Coursera
 * Based on code by Sven Mentl and Pietro Brunetti
 *
 * Copyright (c) Sven Mentl, Pietro Brunetti, Bruce Arden, Tero Keski-Valkama
 */
...
public class App {
    ...
    public static void main(String[] args) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        ...
        EmptyTxHandler txHandler = new EmptyTxHandler(utxoPool);
